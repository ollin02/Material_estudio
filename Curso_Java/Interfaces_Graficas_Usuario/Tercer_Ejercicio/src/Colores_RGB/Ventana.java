...
public class Ventana extends JFrame{
	...
	private void colocarBotones() {
		...
		botonRojo.setFont(new Font("arial rounded mt blod", 0, 20));
		panel.add(botonRojo);
		...
		botonVerde.setFont(new Font("arial rounded me blod", 0,20));
		...
		botonAzul.setFont(new Font("arial rounded me blod", 0,20));
		panel.add(botonAzul);
