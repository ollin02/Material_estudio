...
public class Ventana extends JFrame{
	...
	private void iniciarComponentes() {
		...
		etiqueta.setForeground(Color.ORANGE);//Establecemos el color de la letra de nuesta etiqueta
		etiqueta.setOpaque(true);//Estblecemos pintar el fondo de la etiqueta
		etiqueta.setBackground(Color.YELLOW);//ambiamo es color de fondo de nuestra etiqueta
